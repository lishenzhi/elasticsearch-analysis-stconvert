...
public final class STConvertCharFilter extends BaseCharFilter {
    ...
    private ConvertType convertType=ConvertType.traditional2simple;
    private Reader transformedInput;
    public STConvertCharFilter(Reader in, ConvertType convertType) {
        super(in);
    ...
    CharSequence processPattern(CharSequence input) {
        ...
        String result = STConverter.convert(input.toString(), convertType);
